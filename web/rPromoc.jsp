            ...
            <div class="row">
                <section class="posts col-md-9">
                    ...
                    <section class="jumbotron4">
                        <%
                            rPromo rp = (rPromo) request.getSession().getAttribute("rPromocion");
                            String nombreP = rp.getNumero();
                            DtPromocion rPromocion = null;

                            for (int i = 0; i < IS.listarPromociones().size(); i++) {
                                rPromocion = (DtPromocion) IS.listarPromociones().get(i);
                        %><h3>Nombre: </h3><h4><%= rPromocion.getNombre()%></h4><%
                                if (nombreP.equals(rPromocion.getNombre())) {
                                    i = IS.listarPromociones().size();
                                }
                            }

                            String Nombre = rPromocion.getNombre();
                            float Descuento = rPromocion.getDescuento();
                            float pPrecio = rPromocion.getPrecioTotal();
                            ArrayList S = new ArrayList();
                            S = rPromocion.getServicios();
                        %>

                        <h3>Nombre: </h3><h4><%= Nombre%></h4>
                        <h3>Descuento: </h3><h4><%= Descuento%></h4>
                        <h3>Precio:</h3><h4>$ <%= pPrecio%></h4>
                        ...
                        <form name="form" action="reservaser.do" method="POST"> 
                            ...
                            %> <select class="form-control" name="rS" size="1"> <%
                                for (int i = 0; i < S.size(); i++) {
                                    DtInfoServicio asos = (DtInfoServicio) S.get(i);
                                    String a = asos.getNombre();
                                %>
