...
<%
    ...
    List promociones = IS.listarPromociones();
            ...
            <div class="row">
                <section class="posts col-md-9">
                    ...
                    <section class="jumbotron4">
                        <%
                            rServi rs = (rServi) request.getSession().getAttribute("rServicio");
                            if (rs != null) {
                                String nombreS = rs.getNumero();
                                DtInfoServicio rServicio = null;

                                for (int i = 0; i < servicios.size(); i++) {
                                    rServicio = (DtInfoServicio) IS.listarServicios().get(i);
                                    if (nombreS.equals(rServicio.getNombre())) {
                                        i = servicios.size();
                                    }
                                }
                                String Descripcion = rServicio.getDescipcion();
                                String Origen = rServicio.getOrigen().toString();
                                String Nombre = rServicio.getNombre();
                                float sPrecio = rServicio.getPrecio();
                                String Proveedor = rServicio.getProveedor();
                                String Destino = rServicio.getDestino().toString();

                        %>
                        <h3>Nombre: </h3><h4><%= Nombre%></h4>
                        <h3>Descripcion: </h3><h4><%= Descripcion%></h4>
                        <h3>Precio:</h3><h4>$ <%= sPrecio%></h4>
                        <h3>Origen: </h3><h4><%= Origen%></h4>
                        <% if(Destino!=null){%>
                            <h3>Destino: </h3><h4><%= Destino%></h4>
                        <%}%>
                        <h3>Proveedor: </h3><h4><%= Proveedor%></h4>
                        <h3><br></h3>
                        <%}%>
                    </section>
                </section>
