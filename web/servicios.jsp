        ...
        <section class="main container">
            <div class="row">
                <section class="posts col-md-9">
                    ...
                    <% for (int i = 0; i < serObtenidos.size(); i++) {%>

                    <article class="post clearfix">
                        <a href="#" class="thumb pull-left">
                            <img class="img-thumbnail" src="img/bannerServi.jpg" alt="imgP">
                        </a>
                        <% String num = Integer.toHexString(i + 1); %>
                        <% String nomSer = serObtenidos.get(i).getNombre();%>
                        <% String desSer = serObtenidos.get(i).getDescipcion();%>
                        <form name="form" action="reservaser.do" method="POST">
                            <h2 class="post-title"><a href="#">Servicio <%= nomSer%></a></h2>
                            <input type="hidden" name="rS" value="<%= nomSer%>">
                            </select><button type="submit" class="btn btn-primary">ver mas</button>
                        </form>
                        <p class="post-contenido text-justify"> Descripcion: <%= desSer%></p>
                        <p><span class="post-fecha">26 de Enero de 2016</span> por<span class="post-autor"><a href="#"> <%= serObtenidos.get(i).getProveedor()%></a></span></p>
                        <div class="contenedor-botones">
                            <a href="#" class="btn btn-primary">Agregar a carrito</a>
                            <!-- ACA VOY A LLAMAR A LA FUNCION DE AGREGAR AL CARRITO-->
